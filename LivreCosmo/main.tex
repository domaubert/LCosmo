...
\backmatter
\nocite{*}
\renewcommand{\bibpreamble}{La bibliographie ci-dessous liste les principaux ouvrages qui ont permis de construire ce cours. Les articles scientifiques professionnels mentionnés dans les texte principal n'y sont pas détaillés mais peuvent être retrouvé à partir de leurs auteurs sur le site ADS\sidenote{ http://adsabs.harvard.edu/. }. Au delà d'une simple bibliographie, cette liste constitue surtout une recommandation de liste de lecture pour toute personne désireuse d'aller plus loin.}
